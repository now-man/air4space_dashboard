...
const Header = ({ profile, setActiveView, activeView }) => {
    ...
    const OWM_API_KEY = "5e51e99c2fa4d10dbca840c7c1e1781e"; // <-- 사용자 OWM API 키 입력
    ...
    useEffect(() => {
        if(profile.location.coords.lat && OWM_API_KEY !== "5e51e99c2fa4d10dbca840c7c1e1781e") {
            ...
            const mockWeather = {
                main: { temp: 23.5 + (Math.random() - 0.5) * 2 },
